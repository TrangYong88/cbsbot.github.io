...
class Bot:
    def __init__(self, access_token, **kwargs):
        ...
        self.graph_url = 'https://graph.facebook.com/v{0}'.format(self.api_version)   # api help send, receive message
    ...
    def send_recipient(self, recipient_id, payload, notification_type=NotificationType.regular, messaging_type=None):
        payload['recipient'] = {
            'id': recipient_id
        }
    ...
    def send_message(self, recipient_id, message, notification_type=NotificationType.regular, messaging_type=None):
        return self.send_recipient(recipient_id, {
            'message': message
        }, notification_type, messaging_type)
    ...
    def send_quick_reply(self, recipient_id, text, quick_replies, notification_type=NotificationType.regular):
        """
        Send quick reply messages to the specified recipient
        https://developers.facebook.com/docs/messenger-platform/send-messages/quick-replies#phone
        Args:
            recipient_id: recipient id to send to
            text: text of message to send
            quick_reply: quick reply to send
            notification_type:
        Returns:
            Response from API as <dict>
        """
        ...
        return self.send_message(recipient_id=recipient_id, message=message,
                                 notification_type=NotificationType.regular, messaging_type="RESPONSE")
